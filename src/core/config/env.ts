...
const envSchema = z.object({
  ...
  // Feature flags
  FEATURE_EMAIL_VERIFICATION: z.enum(['true', 'false']).transform(val => val === 'true').default(true),
  FEATURE_PASSWORD_RESET: z.enum(['true', 'false']).transform(val => val === 'true').default(true),
  FEATURE_SESSION_TRACKING: z.enum(['true', 'false']).transform(val => val === 'true').default(true),
